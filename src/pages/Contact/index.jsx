        ...
        <>
            <div className="dark:bg-boxdark">
                ...
                <div className="parent py-16 my-16 dark:bg-boxdark">
                    ...
                    >
                        <h3 className="text-neutral text-center dark:text-white">Contact Us</h3>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
                        ...
                        >
                            <div className="flex items-center my-6">
                                ...
                                <h3 className="font-medium dark:text-white">ERP Solutions Inc.</h3>
                            </div>
                            <div className="flex items-center my-6">
                                <FaPhoneAlt className="text-2xl mr-8 text-primary duration-300"></FaPhoneAlt>
                                <h3 className="font-medium dark:text-white">+1 555-1234</h3>
                            </div>
                            <div className="flex items-center my-6">
                                <MdEmail className="text-3xl mr-8 text-primary duration-300"></MdEmail>
                                <h3 className="font-medium dark:text-white">contact@erp-solutions.com</h3>
                            </div>
                            <div className="flex items-center my-6">
